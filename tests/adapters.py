...
def run_linear(
    ...
    """
    from cs336_basics.langmodel import Linear
...
def run_embedding(
    ...
    """
    from cs336_basics.langmodel import Embedding
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.langmodel import scaled_dot_product_attention
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.langmodel import CausalMultiHeadSelfAttention
    device = in_features.device
    dtype = in_features.dtype
...
def run_rope(
    ...
    """
    from cs336_basics.langmodel import RotaryPositionalEmbedding
...
def run_rmsnorm(
    ...
    """
    from cs336_basics.langmodel import RMSNorm
    rmsnorm = RMSNorm(
        d_model,
        eps,
        device=weights.device,
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.langmodel import softmax
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.train_util import clip_gradients
    return clip_gradients(params=parameters, max_norm=max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.train_util import get_cosine_learning_rate_sched
...
def get_tokenizer(
    ...
    return BytePairEncoder(vocab, merges, special_tokens)
